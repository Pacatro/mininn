...
/// - `Trainable`: For forward and backward computations.
...
/// ```
///
pub trait Layer: Trainable + MSGPackFormatting + Any + DynClone + Debug + Send + Sync {
...
///
/// The `Trainable` trait provides methods required to compute the forward and backward passes
